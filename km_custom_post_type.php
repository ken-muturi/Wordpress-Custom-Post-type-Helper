...
class Km_Post_Type
{
    ...
    public function __construct($name, $args = array(),$labels = array())
    {
        ...
        if(! post_type_exists($this->post_type_name))
        {
            ...
            add_action('post_edit_form_tag', array(&$this, 'km_post_edit_form_tag'));
    ...
    public function km_post_edit_form_tag()
    {
    ...
    public function callback_metabox($post, $metabox)
    {
        ...
        wp_nonce_field(plugin_basename(__FILE__), 'km_post_type');
    ...
    public function save_data()
    {
        ...
        if(isset($_POST['km_post_type']) && ! wp_verify_nonce($_POST['km_post_type'], plugin_basename(__FILE__))) return;
